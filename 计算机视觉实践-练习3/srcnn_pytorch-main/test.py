...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-file', default='E:\研究生作业\计算机视觉实践\计算机视觉实践-练习3\Set5', type=str)
    ...
    save_path = "E:\研究生作业\计算机视觉实践\计算机视觉实践-练习3\srcnn_pytorch-main\img"
    import os
    for file in os.listdir(args.image_file):
        if file.endswith('png'):
            image = pil_image.open(os.path.join(args.image_file,file)).convert('RGB')   # 将图片转为RGB类型
            ...
            output.save(os.path.join(save_path,'out',file))  # 对图像进行保存
